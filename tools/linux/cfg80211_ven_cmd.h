...
enum _ol_ath_param_t {
...
#ifdef WLAN_FEATURE_11BE
	OL_ATH_PARAM_ACS_PUNCTURE_LEGACY_WEIGHTAGE = 482,
	...
	OL_ATH_PARAM_RC_MCS_PROBE_INTVL_MIN = 499,
	OL_ATH_PARAM_RC_MCS_PROBE_INTVL_MAX = 500,
	OL_ATH_PARAM_DISABLE_MCS_PROBE_INTVL = 501,
	OL_ATH_PARAM_RC_NSS_PROBE_INTVL_MIN = 502,
...
#ifdef WLAN_FEATURE_11BE_MLO
	OL_ATH_PARAM_MLO_VDEV_COUNT = 507,
#endif /* WLAN_FEATURE_11BE_MLO */
	/* Configure BCN rate limit params */
	OL_ATH_PARAM_ENABLE_BCN_RATELIMIT = 508,
	OL_ATH_PARAM_BCN_RATELIMIT_COUNT = 509,
	OL_ATH_PARAM_BCN_DROPPED_COUNT = 510,
	...
	OL_ATH_PARAM_TX_RX_SWITCH_OVER = 549,
	OL_ATH_PARAM_PREAMBLE_PWR = 550,
	OL_ATH_PARAM_STOMPER_THRSHOLD = 551,
	OL_ATH_PARAM_AGC_GAIN_VALUE = 552,
	OL_ATH_PARAM_LSIG_RLSIG_POWER_SCALING = 553,
	OL_ATH_PARAM_HESIGA_POWER_SCALING = 554,
	OL_ATH_PARAM_PREAMBLE_POWER_REMOVAL = 555,
};
...
struct vendor_commands vap_vendor_cmds[] = {
	...
	{"g_he_subfee",         IEEE80211_PARAM_HE_SU_BFEE, GET_PARAM, 0},
	{"he_subfer",           IEEE80211_PARAM_HE_SU_BFER, SET_PARAM, 1},
	{"g_he_subfer",         IEEE80211_PARAM_HE_SU_BFER, GET_PARAM, 0},
	{"he_mubfee",           IEEE80211_PARAM_HE_MU_BFEE, SET_PARAM, 1},
	{"g_he_mubfee",         IEEE80211_PARAM_HE_MU_BFEE, GET_PARAM, 0},
	{"he_mubfer",           IEEE80211_PARAM_HE_MU_BFER, SET_PARAM, 1},
	{"g_he_mubfer",         IEEE80211_PARAM_HE_MU_BFER, GET_PARAM, 0},
	...
	{"gcsainteropbss",      IEEE80211_PARAM_CSA_INTEROP_BSS, GET_PARAM, 0},
	{"scsainteropauth",     IEEE80211_PARAM_CSA_INTEROP_AUTH, SET_PARAM, 1},
	{"gcsainteropauth",     IEEE80211_PARAM_CSA_INTEROP_AUTH, GET_PARAM, 0},
...
struct vendor_commands radio_vendor_cmds[] = {
	...
	{"g_sens_level",
		OL_SPECIAL_PARAM_SHIFT | OL_SPECIAL_PARAM_SENS_LEVEL, GET_PARAM, 0},
	{"prof_id_enable",
	...
	{"get_acs_puncture_legacy_weightage",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_ACS_PUNCTURE_LEGACY_WEIGHTAGE, GET_PARAM, 0},
	{"set_acs_puncture_non_ofdma_weightage",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_ACS_PUNCTURE_NOFDMA_WEIGHTAGE, SET_PARAM, 1},
	{"get_acs_puncture_non_ofdma_weightage",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_ACS_PUNCTURE_NOFDMA_WEIGHTAGE, GET_PARAM, 0},
	{"set_acs_puncture_ofdma_weightage",
	...
	{"disable_rate_retry_mcs_drop",
		...
		SET_PARAM, 1},
	{"get_mcs_probe_intvl_min",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_RC_MCS_PROBE_INTVL_MIN,
		GET_PARAM, 0},
	{"get_mcs_probe_intvl_max",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_RC_MCS_PROBE_INTVL_MAX,
		GET_PARAM, 0},
	{"disable_mcs_probe_intvl",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_DISABLE_MCS_PROBE_INTVL,
		SET_PARAM, 1},
	{"get_nss_probe_intvl_min",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_RC_NSS_PROBE_INTVL_MIN,
		GET_PARAM, 0},
	{"get_nss_probe_intvl_max",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_RC_NSS_PROBE_INTVL_MAX,
		GET_PARAM, 0},
	...
	{"g_bcn_rlimit",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_ENABLE_BCN_RATELIMIT, GET_PARAM, 0},
	{"bcnRlimitCount",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_BCN_RATELIMIT_COUNT, SET_PARAM, 1},
	{"gbcnRlimitCount",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_BCN_RATELIMIT_COUNT, GET_PARAM, 0},
	{"gbcnDroppedCount",
		OL_ATH_PARAM_SHIFT | OL_ATH_PARAM_BCN_DROPPED_COUNT, GET_PARAM, 0},
#if defined(CONFIG_AFC_SUPPORT)
