 ...
 */
#ifndef _HAL_5424_TX_H_
#define _HAL_5424_TX_H_
...
/**
 * hal_tx_get_num_ppe_vp_search_idx_reg_entries_5424() - get number of PPE VP
 ...
 */
static uint32_t
hal_tx_get_num_ppe_vp_search_idx_reg_entries_5424(hal_soc_handle_t hal_soc_hdl)
{
	return HAL_PPE_VP_SEARCH_IDX_REG_MAX;
}

/**
 * hal_tx_set_dscp_tid_map_5424() - Configure default DSCP to TID map table
 ...
 * Return: none
 */
static void hal_tx_set_dscp_tid_map_5424(struct hal_soc *hal_soc, uint8_t *map,
		uint8_t id)
{
	int i;
	...
	if (id >= HAL_MAX_HW_DSCP_TID_V2_MAPS_5424)
		return;
...
/**
 * hal_tx_update_dscp_tid_5424() - Update the dscp tid map table as updated
 *					by the user
 * @soc: HAL SoC context
 ...
 * Return: void
 */
static void hal_tx_update_dscp_tid_5424(struct hal_soc *soc, uint8_t tid,
...
/**
 * hal_tx_config_rbm_mapping_be_5424() - Update return buffer manager ring id
 ...
 */
static inline void
hal_tx_config_rbm_mapping_be_5424(hal_soc_handle_t hal_soc_hdl,
...
/**
 * hal_tx_init_cmd_credit_ring_5424() - Initialize command/credit SRNG
 ...
 */
static inline void
hal_tx_init_cmd_credit_ring_5424(hal_soc_handle_t hal_soc_hdl,
		hal_ring_handle_t hal_ring_hdl)
{
}
...
typedef struct tx_fes_setup_compact_5424 hal_tx_fes_setup_t;
struct tx_fes_setup_compact_5424 {
	/* DWORD - 0 */
...
typedef struct tx_peer_entry_compact_5424 hal_tx_peer_entry_t;
struct tx_peer_entry_compact_5424 {
	/* DWORD - 0 */
...
typedef struct tx_queue_ext_compact_5424 hal_tx_queue_ext_t;
struct tx_queue_ext_compact_5424 {
	/* DWORD - 0 */
...
typedef struct tx_msdu_start_compact_5424 hal_tx_msdu_start_t;
struct tx_msdu_start_compact_5424 {
	/* DWORD - 0 */
...
typedef struct tx_mpdu_start_compact_5424 hal_tx_mpdu_start_t;
struct tx_mpdu_start_compact_5424 {
	/* DWORD - 0 */
...
typedef struct rxpcu_user_setup_compact_5424  hal_rxpcu_user_setup_t;
struct rxpcu_user_setup_compact_5424 {
};

#define TX_FES_STATUS_END_MASK 0x7
typedef struct tx_fes_status_end_compact_5424 hal_tx_fes_status_end_t;
struct tx_fes_status_end_compact_5424 {
	/* DWORD - 0 */
	uint32_t reserved_0                     : 32;
	/* DWORD - 1 */
	struct {
...
typedef struct response_end_status_compact_5424 hal_response_end_status_t;
struct response_end_status_compact_5424 {
	/* DWORD - 0 */
...
typedef struct tx_fes_status_prot_compact_5424 hal_tx_fes_status_prot_t;
struct tx_fes_status_prot_compact_5424 {
	/* DWORD - 2 */
	uint32_t start_of_frame_timestamp_15_0  : 16,
		 start_of_frame_timestamp_31_16 : 16;
	/* DWROD - 3 */
...
typedef struct pcu_ppdu_setup_init_compact_5424 hal_pcu_ppdu_setup_t;
struct pcu_ppdu_setup_init_compact_5424 {
	/* DWORD - 46 */
...
/**
 * hal_txmon_get_word_mask_qca5424() - api to get word mask for tx monitor
 * @wmask: pointer to hal_txmon_word_mask_config_t
 *
 * Return: void
 */
static inline
void hal_txmon_get_word_mask_qca5424(void *wmask)
{
...
/**
 * hal_tx_set_ppe_cmn_config_5424() - Set the PPE common config register
 * @hal_soc_hdl: HAL SoC handle
 ...
 */
static inline
void hal_tx_set_ppe_cmn_config_5424(hal_soc_handle_t hal_soc_hdl,
...
/**
 * hal_tx_set_ppe_vp_entry_5424() - Set the PPE VP entry
 * @hal_soc_hdl: HAL SoC handle
 * @cfg: PPE VP config
 ...
 */
static inline
void hal_tx_set_ppe_vp_entry_5424(hal_soc_handle_t hal_soc_hdl,
...
/**
 * hal_ppeds_cfg_ast_override_map_reg_5424() - Set the PPE index mapping table
 * @hal_soc_hdl: HAL SoC context
 ...
 */
static inline void
hal_ppeds_cfg_ast_override_map_reg_5424(hal_soc_handle_t hal_soc_hdl,
		uint8_t idx,
...
/**
 * hal_tx_set_ppe_pri2tid_map_5424()
 * @hal_soc_hdl: HAL SoC handle
 ...
 */
static inline
void hal_tx_set_ppe_pri2tid_map_5424(hal_soc_handle_t hal_soc_hdl,
...
static inline
void hal_tx_enable_pri2tid_map_5424(hal_soc_handle_t hal_soc_hdl,
...
static inline
void hal_tx_update_ppe_pri2tid_5424(hal_soc_handle_t hal_soc_hdl,
...
/*
 * hal_tx_dump_ppe_vp_entry_5424()
 * @hal_soc_hdl: HAL SoC handle
 *
 * Return: void
 */
static inline
void hal_tx_dump_ppe_vp_entry_5424(hal_soc_handle_t hal_soc_hdl)
{
	struct hal_soc *soc = (struct hal_soc *)hal_soc_hdl;
 ...
 */
static
uint32_t hal_tx_get_num_ppe_vp_tbl_entries_5424(hal_soc_handle_t hal_soc_hdl)
{
	return HAL_PPE_VP_ENTRIES_MAX;
}

/**
 * hal_tx_ppe2tcl_ring_halt_set_5424() - Enable ring halt for the ppe2tcl ring
 * @hal_soc: HAL SoC context
 *
 * Return: none
 */
static void hal_tx_ppe2tcl_ring_halt_set_5424(hal_soc_handle_t hal_soc)
{
...
/**
 * hal_tx_ppe2tcl_ring_halt_reset_5424() - Disable ring halt for the ppe2tcl ring
 * @hal_soc: HAL SoC context
 *
 * Return: none
 */
static void hal_tx_ppe2tcl_ring_halt_reset_5424(hal_soc_handle_t hal_soc)
{
	uint32_t cmn_reg_addr;
	uint32_t regval;
	struct hal_soc *soc = (struct hal_soc *)hal_soc;
...
/**
 * hal_tx_ppe2tcl_ring_halt_done_5424() - Check if ring halt is done for ppe2tcl ring
 * @hal_soc: HAL SoC context
 *
 * Return: true if halt done
 */
static bool hal_tx_ppe2tcl_ring_halt_done_5424(hal_soc_handle_t hal_soc)
{
	uint32_t cmn_reg_addr;
	uint32_t regval;
	struct hal_soc *soc = (struct hal_soc *)hal_soc;
