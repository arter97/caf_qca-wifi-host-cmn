...
/**
 * hal_rx_mpdu_start_tid_get_5018() - API to get tid from rx_msdu_start
 * @buf: pointer to the start of RX PKT TLV header
 *
...
/**
 * hal_rx_msdu_start_reception_type_get_5018() - API to get the reception type
 *                                               Interval from rx_msdu_start
 * @buf: pointer to the start of RX PKT TLV header
 *
...
/**
 * hal_rx_msdu_end_da_idx_get_5018() - API to get da_idx from rx_msdu_end TLV
 * @buf: pointer to the start of RX PKT TLV headers
 *
 * Return: da index
 */
...
/**
 * hal_rx_get_rx_fragment_number_5018() - API to retrieve rx fragment number
 * @buf: Network buffer
 *
...
/**
 * hal_rx_msdu_end_sa_is_valid_get_5018() - API to get_5018 the sa_is_valid
...
/**
 * hal_rx_msdu_end_sa_idx_get_5018() - API to get_5018 the sa_idx from
 *                                     rx_msdu_end TLV
 * @buf: pointer to the start of RX PKT TLV headers
 *
...
/**
 * hal_rx_get_mpdu_mac_ad4_valid_5018() - Retrieves if mpdu 4th addr is valid
 * @buf: Network buffer
 *
...
/**
 * hal_rx_mpdu_get_to_ds_5018() - API to get the tods info from
 *                                rx_mpdu_start
 * @buf: pointer to the start of RX PKT TLV header
 *
...
/**
 * hal_rx_mpdu_get_fr_ds_5018() - API to get the from ds info from
 *                                rx_mpdu_start
 * @buf: pointer to the start of RX PKT TLV header
 *
...
/**
 * hal_rx_get_mpdu_frame_control_valid_5018() - Retrieves mpdu frame
 *                                              control valid
 * @buf: Network buffer
 *
...
/**
 * hal_rx_get_mpdu_frame_control_field_5018() - Function to retrieve
 *                                              frame control field
 * @buf: Network buffer
 *
...
/**
 * hal_rx_get_mpdu_sequence_control_valid_5018() - Get mpdu sequence
 *                                                 control valid
 * @buf: Network buffer
 *
 ...
 *
 */
static void hal_reo_status_get_header_5018(hal_ring_desc_t ring_desc, int b,
					   void *h1)
{
...
/**
 * hal_rx_msdu_flow_idx_get_5018() - API to get flow index from
 *                                   rx_msdu_end TLV
 * @buf: pointer to the start of RX PKT TLV headers
 *
...
/**
 * hal_rx_msdu_get_flow_params_5018() - API to get flow index, flow index
...
/**
 * hal_rx_msdu_packet_metadata_get_5018() - API to get the msdu
 *                                          information from rx_msdu_end TLV
 * @buf: pointer to the start of RX PKT TLV headers
...
static void hal_hw_txrx_ops_attach_qca5018(struct hal_soc *hal_soc)
{
	/* init and setup */
	...
	hal_soc->ops->hal_get_window_address = hal_get_window_address_5018;
	...
	hal_soc->ops->hal_tx_desc_set_lmac_id = hal_tx_desc_set_lmac_id_5018;
	...
	hal_soc->ops->hal_tx_desc_set_mesh_en = hal_tx_desc_set_mesh_en_5018;
	...
	hal_soc->ops->hal_rx_print_pn = hal_rx_print_pn_5018;
	...
	hal_soc->ops->hal_rx_mpdu_get_addr4 = hal_rx_mpdu_get_addr4_5018;
	hal_soc->ops->hal_rx_get_mpdu_sequence_control_valid =
		hal_rx_get_mpdu_sequence_control_valid_5018;
	hal_soc->ops->hal_rx_is_unicast = hal_rx_is_unicast_5018;
	hal_soc->ops->hal_rx_tid_get = hal_rx_tid_get_5018;
	...
	hal_soc->ops->hal_ent_mpdu_desc_info = hal_ent_mpdu_desc_info_5018;
	hal_soc->ops->hal_dst_mpdu_desc_info = hal_dst_mpdu_desc_info_5018;
	hal_soc->ops->hal_rx_get_fc_valid = hal_rx_get_fc_valid_5018;
	hal_soc->ops->hal_rx_get_to_ds_flag = hal_rx_get_to_ds_flag_5018;
	...
	hal_soc->ops->hal_rx_get_ppdu_id = hal_rx_get_ppdu_id_5018;
	hal_soc->ops->hal_reo_config = hal_reo_config_5018;
	hal_soc->ops->hal_rx_msdu_flow_idx_get = hal_rx_msdu_flow_idx_get_5018;
	...
	hal_soc->ops->hal_rx_get_rx_sequence = hal_rx_get_rx_sequence_5018;
#if defined(WLAN_CFR_ENABLE) && defined(WLAN_ENH_CFR_ENABLE)
	hal_soc->ops->hal_rx_get_bb_info = hal_rx_get_bb_info_5018;
	hal_soc->ops->hal_rx_get_rtt_info = hal_rx_get_rtt_info_5018;
#endif
