...
#define STATS_FEAT_FLG_EXT             0x00000040
...
#define STATS_FEAT_FLG_ALL             \
	(STATS_FEAT_FLG_RX | STATS_FEAT_FLG_TX | STATS_FEAT_FLG_AST | \
	 STATS_FEAT_FLG_CFR | STATS_FEAT_FLG_FWD | STATS_FEAT_FLG_RAW | \
	 STATS_FEAT_FLG_TSO | STATS_FEAT_FLG_TWT | STATS_FEAT_FLG_VOW | \
	 STATS_FEAT_FLG_WDI | STATS_FEAT_FLG_WMI | STATS_FEAT_FLG_IGMP | \
	 STATS_FEAT_FLG_LINK | STATS_FEAT_FLG_MESH | STATS_FEAT_FLG_RATE | \
...
#define STATS_ADVANCE_STA_DATA_MASK                    \
	(STATS_BASIC_STA_DATA_MASK |                   \
	 ...
	 STATS_FEAT_FLG_RAW | STATS_FEAT_FLG_EXT |     \
 ...
 * @STATS_OBJ_LINK:  Stats for a link of an MLD
 * @STATS_OBJ_LAST:  End of enum elements
...
enum stats_object_e {
	...
	/* New element must be above this */
	STATS_OBJ_LAST,
	STATS_OBJ_MAX = STATS_OBJ_LAST - 1,
};
