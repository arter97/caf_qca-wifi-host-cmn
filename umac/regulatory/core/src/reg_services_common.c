...
const struct chan_map channel_map_us[NUM_CHANNELS] = {
	...
	[CHAN_ENUM_2419] = {2419, 204, 5, 10},
	[CHAN_ENUM_2422] = {2422, 3, 5, 40},
	[CHAN_ENUM_2424] = {2424, 205, 5, 10},
	[CHAN_ENUM_2427] = {2427, 4, 5, 40},
	[CHAN_ENUM_2429] = {2429, 206, 5, 10},
	[CHAN_ENUM_2432] = {2432, 5, 5, 40},
	[CHAN_ENUM_2434] = {2434, 207, 5, 10},
	[CHAN_ENUM_2437] = {2437, 6, 5, 40},
	[CHAN_ENUM_2439] = {2439, 208, 5, 10},
	[CHAN_ENUM_2442] = {2442, 7, 5, 40},
	[CHAN_ENUM_2444] = {2444, 209, 5, 10},
	[CHAN_ENUM_2447] = {2447, 8, 5, 40},
	[CHAN_ENUM_2449] = {2449, 210, 5, 10},
	[CHAN_ENUM_2452] = {2452, 9, 5, 40},
	[CHAN_ENUM_2454] = {2454, 211, 5, 10},
	[CHAN_ENUM_2457] = {2457, 10, 5, 40},
	[CHAN_ENUM_2459] = {2459, 212, 5, 10},
	[CHAN_ENUM_2462] = {2462, 11, 5, 40},
	[CHAN_ENUM_2464] = {2464, 213, 5, 10},
	[CHAN_ENUM_2467] = {2467, 12, 5, 40},
	[CHAN_ENUM_2469] = {2469, 214, 5, 10},
	[CHAN_ENUM_2472] = {2472, 13, 5, 40},
	[CHAN_ENUM_2474] = {2474, 215, 5, 10},
	[CHAN_ENUM_2477] = {2477, 221, 5, 10},
...
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5185] = {5185, 37, 2, 10},
	[CHAN_ENUM_5190] = {5190, 38, 2, 10},
	[CHAN_ENUM_5195] = {5195, 39, 2, 10},
#endif
	[CHAN_ENUM_5200] = {5200, 40, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5205] = {5205, 41, 2, 10},
	[CHAN_ENUM_5210] = {5210, 42, 2, 10},
	[CHAN_ENUM_5215] = {5215, 43, 2, 10},
#endif
	[CHAN_ENUM_5220] = {5220, 44, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5225] = {5225, 45, 2, 10},
	[CHAN_ENUM_5230] = {5230, 46, 2, 10},
	[CHAN_ENUM_5235] = {5235, 47, 2, 10},
#endif
	[CHAN_ENUM_5240] = {5240, 48, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5245] = {5245, 49, 2, 10},
	[CHAN_ENUM_5250] = {5250, 50, 2, 10},
	[CHAN_ENUM_5255] = {5255, 51, 2, 10},
#endif
	[CHAN_ENUM_5260] = {5260, 52, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5265] = {5265, 53, 2, 10},
	[CHAN_ENUM_5270] = {5270, 54, 2, 10},
	[CHAN_ENUM_5275] = {5275, 55, 2, 10},
#endif
	[CHAN_ENUM_5280] = {5280, 56, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5285] = {5285, 57, 2, 10},
	[CHAN_ENUM_5290] = {5290, 58, 2, 10},
	[CHAN_ENUM_5295] = {5295, 59, 2, 10},
#endif
	[CHAN_ENUM_5300] = {5300, 60, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5305] = {5305, 61, 2, 10},
	[CHAN_ENUM_5310] = {5310, 62, 2, 10},
	[CHAN_ENUM_5315] = {5315, 63, 2, 10},
#endif
	[CHAN_ENUM_5320] = {5320, 64, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5325] = {5325, 65, 2, 10},
	[CHAN_ENUM_5495] = {5495, 99, 2, 10},
#endif
	[CHAN_ENUM_5500] = {5500, 100, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5505] = {5505, 101, 2, 10},
	[CHAN_ENUM_5510] = {5510, 102, 2, 10},
	[CHAN_ENUM_5515] = {5515, 103, 2, 10},
#endif
	[CHAN_ENUM_5520] = {5520, 104, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5525] = {5525, 105, 2, 10},
	[CHAN_ENUM_5530] = {5530, 106, 2, 10},
	[CHAN_ENUM_5535] = {5535, 107, 2, 10},
#endif
	[CHAN_ENUM_5540] = {5540, 108, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5545] = {5545, 109, 2, 10},
	[CHAN_ENUM_5550] = {5550, 110, 2, 10},
	[CHAN_ENUM_5555] = {5555, 111, 2, 10},
#endif
	[CHAN_ENUM_5560] = {5560, 112, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5565] = {5565, 113, 2, 10},
	[CHAN_ENUM_5570] = {5570, 114, 2, 10},
	[CHAN_ENUM_5575] = {5575, 115, 2, 10},
#endif
	[CHAN_ENUM_5580] = {5580, 116, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5585] = {5585, 117, 2, 10},
	[CHAN_ENUM_5590] = {5590, 118, 2, 10},
	[CHAN_ENUM_5595] = {5595, 119, 2, 10},
#endif
	[CHAN_ENUM_5600] = {5600, 120, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5605] = {5605, 121, 2, 10},
	[CHAN_ENUM_5610] = {5610, 122, 2, 10},
	[CHAN_ENUM_5615] = {5615, 123, 2, 10},
#endif
	[CHAN_ENUM_5620] = {5620, 124, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5625] = {5625, 125, 2, 10},
	[CHAN_ENUM_5630] = {5630, 126, 2, 10},
	[CHAN_ENUM_5635] = {5635, 127, 2, 10},
#endif
	[CHAN_ENUM_5640] = {5640, 128, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5645] = {5645, 129, 2, 10},
	[CHAN_ENUM_5650] = {5650, 130, 2, 10},
	[CHAN_ENUM_5655] = {5655, 131, 2, 10},
#endif
	[CHAN_ENUM_5660] = {5660, 132, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5665] = {5665, 133, 2, 10},
	[CHAN_ENUM_5670] = {5670, 134, 2, 10},
	[CHAN_ENUM_5675] = {5675, 135, 2, 10},
#endif
	[CHAN_ENUM_5680] = {5680, 136, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5685] = {5685, 137, 2, 10},
	[CHAN_ENUM_5690] = {5690, 138, 2, 10},
	[CHAN_ENUM_5695] = {5695, 139, 2, 10},
#endif
	[CHAN_ENUM_5700] = {5700, 140, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5705] = {5705, 141, 2, 10},
	[CHAN_ENUM_5710] = {5710, 142, 2, 10},
	[CHAN_ENUM_5715] = {5715, 143, 2, 10},
#endif
	[CHAN_ENUM_5720] = {5720, 144, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5725] = {5725, 145, 2, 10},
	[CHAN_ENUM_5740] = {5740, 148, 2, 10},
#endif
	[CHAN_ENUM_5745] = {5745, 149, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5750] = {5750, 150, 2, 10},
	[CHAN_ENUM_5755] = {5755, 151, 2, 10},
	[CHAN_ENUM_5760] = {5760, 152, 2, 10},
#endif
	[CHAN_ENUM_5765] = {5765, 153, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5770] = {5770, 154, 2, 10},
	[CHAN_ENUM_5775] = {5775, 155, 2, 10},
	[CHAN_ENUM_5780] = {5780, 156, 2, 10},
#endif
	[CHAN_ENUM_5785] = {5785, 157, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5790] = {5790, 158, 2, 10},
	[CHAN_ENUM_5795] = {5795, 159, 2, 10},
	[CHAN_ENUM_5800] = {5800, 160, 2, 10},
#endif
	[CHAN_ENUM_5805] = {5805, 161, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5810] = {5810, 162, 2, 10},
	[CHAN_ENUM_5815] = {5815, 163, 2, 10},
	[CHAN_ENUM_5820] = {5820, 164, 2, 10},
#endif
	[CHAN_ENUM_5825] = {5825, 165, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5830] = {5830, 166, 2, 10},
	[CHAN_ENUM_5835] = {5835, 167, 2, 10},
	[CHAN_ENUM_5840] = {5840, 168, 2, 10},
#endif
	[CHAN_ENUM_5845] = {5845, 169, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5850] = {5850, 170, 2, 10},
	[CHAN_ENUM_5855] = {5855, 171, 2, 10},
	[CHAN_ENUM_5860] = {5860, 172, 2, 10},
#else
...
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5870] = {5870, 174, 2, 10},
	[CHAN_ENUM_5875] = {5875, 175, 2, 10},
	[CHAN_ENUM_5880] = {5880, 176, 2, 10},
#else
#ifdef WLAN_FEATURE_DSRC
...
const struct chan_map channel_map_eu[NUM_CHANNELS] = {
	...
	[CHAN_ENUM_5845] = {5845, 169, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5850] = {5850, INVALID_CHANNEL_NUM, 2, 10},
	[CHAN_ENUM_5855] = {5855, INVALID_CHANNEL_NUM, 2, 10},
	[CHAN_ENUM_5860] = {5860, INVALID_CHANNEL_NUM, 2, 10},
#else
#ifdef WLAN_FEATURE_DSRC
	...
	[CHAN_ENUM_5865] = {5865, 173, 2, 160},
#ifdef CONFIG_HALF_QUARTER_RATE_FOR_ALL_CHANS
	[CHAN_ENUM_5870] = {5870, INVALID_CHANNEL_NUM, 2, 10},
	[CHAN_ENUM_5875] = {5875, INVALID_CHANNEL_NUM, 2, 10},
	[CHAN_ENUM_5880] = {5880, INVALID_CHANNEL_NUM, 2, 10},
#else
#ifdef WLAN_FEATURE_DSRC
