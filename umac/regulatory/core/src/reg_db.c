...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(ARGENTINA, APL16_ETSIC, FCC1_6G_05, AR, 40, 160, 320, 0),
	...
	CE(AZERBAIJAN, ETSI8_WORLD, ETSI1_6G_02, AZ, 40, 160, 320, 0),
	...
	CE(CANADA, FCC6_FCCA, FCC1_6G_10, CA, 40, 160, 320, 0),
	...
	CE(MEXICO, APL16_ETSIC, APL5_APL6_6G_15, MX, 40, 160, 320, 0),
	...
	CE(NAMIBIA, APL20_WORLD, ETSI1_6G_02, NA, 40, 160, 320, 0),
	...
	CE(RUSSIA, ETSI8_WORLD, ETSI1_6G_02, RU, 40, 160, 320, 0),
	...
	CE(SOUTH_AFRICA, ETSI20_WORLD, ETSI1_6G_02, ZA, 40, 160, 320, 0),
	...
	CE(THAILAND, APL20_WORLD, ETSI2_6G_0C, TH, 40, 160, 320, 0),
...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(ARGENTINA, APL17_ETSIC, FCC1_6G_05, AR, 40, 160, 320, 0),
	CE(ARMENIA, APL4_WORLD, 0, AM, 40, 160, 0, 0),
	CE(ARUBA, ETSI1_WORLD, FCC1_6G_01, AW, 40, 160, 320, 0),
	CE(AUSTRALIA, APL25_ETSIC, ETSI2_6G_0C, AU, 40, 160, 320, 0),
	...
	CE(CAMBODIA, ETSI1_WORLD, 0, KH, 40, 160, 0, 0),
	CE(CAMEROON, ETSI1_WORLD, 0, CM, 40, 160, 0, 0),
	CE(CANADA, FCC3_FCCA, FCC1_6G_10, CA, 40, 160, 320, 0),
	CE(CAYMAN_ISLANDS, FCC17_WORLD, FCC1_6G_01, KY, 40, 160, 320, 0),
	CE(CENTRAL_AFRICA_REPUBLIC, FCC17_WORLD, 0, CF, 40, 40, 0, 0),
	CE(CHAD, ETSI1_WORLD, 0, TD, 40, 160, 0, 0),
	CE(CHILE, FCC20_FCCA, APL7_6G_13, CL, 40, 160, 320, 0),
...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(CHAD, ETSI1_WORLD, 0, TD, 40, 160, 0, 0),
	CE(CHILE, FCC20_FCCA, APL7_6G_13, CL, 40, 160, 320, 0),
	CE(CHINA, APL30_CHNA, 0, CN, 40, 160, 0, 0),
	CE(CHRISTMAS_ISLAND, APL25_ETSIC, ETSI2_6G_0C, CX, 40, 160, 320, 0),
	CE(COLOMBIA, FCC17_FCCA, 0, CO, 40, 160, 0, 0),
	CE(CONGO, ETSI12_WORLD, 0, CG, 40, 160, 0, 0),
	CE(CONGO_DEMOCRATIC_REPUBLIC, ETSI20_WORLD, 0, CD, 40, 160, 0, 0),
...
const struct reg_domain_pair g_reg_dmn_pairs[] = {
	...
	{FCC22_FCCA, FCC22, FCCA},
	{FCC23_FCCA, FCC23, FCCA},
...
const struct regulatory_rule reg_rules_5g[] = {
	...
	[CHAN_5735_5835_12] = {5735, 5835, 80, 33, 0},
	...
	[CHAN_5835_5895_2] = {5835, 5895, 40, 36, REGULATORY_CHAN_INDOOR_ONLY},
	[CHAN_5850_5925_1] = {5850, 5925, 20, 24, 0},
	[CHAN_5850_5925_2] = {5850, 5925, 20, 30, 0},
	[CHAN_5850_5895_3] = {5850, 5895, 20, 36, 0},
	[CHAN_5850_5895_4] = {5850, 5895, 20, 30, REGULATORY_CHAN_INDOOR_ONLY},
#if defined(CONFIG_BAND_6GHZ) && defined(COMPILE_REGDB_6G)
...
const struct regdomain regdomains_5g[] = {
	...
	[FCC22] = {CTL_FCC, DFS_FCC_REGION, 2, 160, 6, 5, {CHAN_5170_5250_12,
							  CHAN_5250_5330_7,
							  CHAN_5490_5590_1,
							  CHAN_5650_5730_1,
							  CHAN_5735_5835_2,
	...
	[FCC23] = {CTL_FCC, DFS_FCC_REGION, 2, 160, 6, 5, {CHAN_5170_5250_12,
							  CHAN_5250_5330_7,
							  CHAN_5490_5590_1,
							  CHAN_5650_5730_1,
							  CHAN_5735_5835_2,
	...
	[APL30] = {CTL_CHN, DFS_CN_REGION, 2, 80, 0, 4, {CHAN_5735_5835_12} },
...
static const struct sixghz_super_to_subdomains g_6g_reg_dmn_9_tuples[] = {
	...
	{APL5_APL6_6G_15, APL5_AP_LPI_6G, 0, APL6_VLP_6G,
	 {APL5_CLI_LPI_DEFAULT_6G, APL5_CLI_LPI_DEFAULT_6G},
	 {0, 0}, {0, 0} },
};
...
static const struct regulatory_rule_ext reg_rules_6g[] = {
	...
	[CHAN_5925_6425_16] = {5925, 6425, 320, 14, 1, 0},
...
static const struct sub_6g_regdomain sub_regdomains_6g[] = {
	...
	[APL6_AP_LPI_6G]  = {2, 320, 4, {CHAN_5925_6425_12,
					 ...
					 CHAN_6525_6875_13,
					 CHAN_6875_7125_10} },
	[APL6_VLP_6G]  = {2, 320, 1, {CHAN_5925_6425_16 },
