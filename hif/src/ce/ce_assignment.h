...
#define CE_HTT_H2T_MSG_SRC_NENTRIES_QCN7605 (WLAN_CE4_SZ_QCN7605)
...
#define QCN_5424_CE_COUNT 12
static struct CE_attr host_ce_config_wlan_qca5424[] = {
	/* host->target HTC control and raw streams */
	{/*CE0*/ (CE_ATTR_FLAGS), 0, 16, 2048, 0, NULL,},
	/* target->host HTT + HTC control */
	{/*CE1*/ (CE_ATTR_FLAGS), 0, 0,  2048, 512, NULL,},
...
static struct CE_pipe_config target_ce_config_wlan_qca5424[] = {
	/* host->target HTC control and raw streams */
	{ /* CE0 */ 0, PIPEDIR_OUT, 32, 2048, CE_ATTR_FLAGS, 0,},
	/* target->host HTT */
	{ /* CE1 */ 1, PIPEDIR_IN,  32, 2048, CE_ATTR_FLAGS, 0,},
...
static struct CE_attr host_ce_config_wlan_wcn6450[] = {
	...
	{ /* CE1 */ CE_ATTR_FLAGS, 0, 0,  2048, 512, NULL,},
	/* target->host WMI */
	{ /* CE2 */ CE_ATTR_FLAGS, 0, 0,  3520, 128, NULL,},
	/* host->target WMI */
	{ /* CE3 */ CE_ATTR_FLAGS, 0, 32, 3520, 0, NULL,},
...
static struct CE_attr host_ce_config_wlan_wcn7750[] = {
	/* host->target HTC control and raw streams */
	{ /* CE0 */ CE_ATTR_FLAGS, 0, 16, 2048, 0, NULL,},
	/* target->host HTT + HTC control */
	{ /* CE1 */ CE_ATTR_FLAGS, 0, 0,  2048, 512, NULL,},
...
static struct CE_pipe_config target_ce_config_wlan_wcn7750[] = {
	/* host->target HTC control and raw streams */
	{ /* CE0 */ 0, PIPEDIR_OUT, 32, 2048, CE_ATTR_FLAGS, 0,},
	/* target->host HTT */
	{ /* CE1 */ 1, PIPEDIR_IN,  32, 2048, CE_ATTR_FLAGS, 0,},
...
#define QCC_2072_CE_COUNT 9
static struct CE_attr host_ce_config_wlan_qcc2072[] = {
	/* host->target HTC control and raw streams */
	{ /* CE0 */ CE_ATTR_FLAGS, 0, 16, 2048, 0, NULL,},
	/* target->host HTT + HTC control */
	{ /* CE1 */ CE_ATTR_FLAGS, 0, 0,  2048, 512, NULL,},
...
static struct CE_pipe_config target_ce_config_wlan_qcc2072[] = {
	/* host->target HTC control and raw streams */
	{ /* CE0 */ 0, PIPEDIR_OUT, 32, 2048, CE_ATTR_FLAGS, 0,},
	/* target->host HTT */
	{ /* CE1 */ 1, PIPEDIR_IN,  32, 2048, CE_ATTR_FLAGS, 0,},
