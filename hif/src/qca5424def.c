...
#define QCA5424_BOARD_DATA_SZ MISSING
#define QCA5424_BOARD_EXT_DATA_SZ MISSING

#define MY_TARGET_DEF QCA5424_TARGETDEF
#define MY_HOST_DEF QCA5424_HOSTDEF
#define MY_CEREG_DEF QCA5424_CE_TARGETDEF
#define MY_TARGET_BOARD_DATA_SZ QCA5424_BOARD_DATA_SZ
#define MY_TARGET_BOARD_EXT_DATA_SZ QCA5424_BOARD_EXT_DATA_SZ
#include "targetdef.h"
#include "hostdef.h"
qdf_export_symbol(QCA5424_CE_TARGETDEF);
#else
#include "common_drv.h"
#include "targetdef.h"
#include "hostdef.h"
struct targetdef_s *QCA5424_TARGETDEF;
struct hostdef_s *QCA5424_HOSTDEF;
#endif /*QCA5424_HEADERS_DEF */
qdf_export_symbol(QCA5424_TARGETDEF);
qdf_export_symbol(QCA5424_HOSTDEF);
